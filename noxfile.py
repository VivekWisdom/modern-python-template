...
def docs(session: Session) -> None:
    ...
    session.run("poetry", "install", "--no-dev", external=True)
    install_with_constraints(session, "sphinx", "sphinx-autodoc-typehints", "--use-deprecated=legacy-resolver")
...
def coverage(session: Session) -> None:
    ...
    install_with_constraints(session, "coverage[toml]", "codecov", "--use-deprecated=legacy-resolver")
